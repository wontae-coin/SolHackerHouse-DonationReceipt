...
export async function main() {
    ...
    console.log("mintKeypair.publicKey : ",mintKeypair.publicKey ) // Mint ( Token address)
    console.log("tokenAddress : ", tokenAddress)  //  Token account
    console.log("wallet.publicKey : ", wallet.publicKey )
    console.log("SYSVAR_RENT_PUBKEY : ", SYSVAR_RENT_PUBKEY ) 
    console.log("SystemProgram.programId", SystemProgram.programId )
    console.log("TOKEN_PROGRAM_ID", TOKEN_PROGRAM_ID )  // SPL_TOKEN Program
